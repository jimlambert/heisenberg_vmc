#ifndef LADDER_WAVEFUNCTION_H
#define LADDER_WAVEFUNCTION_H
...
// VMC::LadderWavefunctions
// =============================================================================
// A wavefunction designed to simulation a ladder structure in memory
// =============================================================================

class LadderWavefunction {
  private: 
    // random number stuff -----------------------------------------------------
    ...
    size_t            _nrungs; // size of the spin model
    size_t            _size;
